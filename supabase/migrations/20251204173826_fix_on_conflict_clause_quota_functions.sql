/*
  # Fix ON CONFLICT Clause in Quota Validation Functions

  ## Changes
  - Use constraint name in ON CONFLICT instead of column names to avoid ambiguity
*/

-- Fix get_designer_current_usage function
...
BEGIN
  ...
  ON CONFLICT ON CONSTRAINT subscription_usage_tracking_designer_subscription_id_period_key
  DO NOTHING;
...
-- Fix increment_designer_quote_usage function
